...
export function New() {
  ...
  async function handleNewPlate() {
    ...
    if (ingredients.length < 1) {
      alert("Adicione no minimo 1 ingrediente!");
    } else {
  ...
  <header>      
          <button className="button-logo " aria-label= "button-back" onClick={backToHome}>
  ...
  <Form>
          ...
          <InputWrapper>
            ...
            <div>
              ...
              <ImgPlate>
                <label htmlFor="file-image">Selecione imagem</label>
...
{/* 
          <div className="buttons"> */}
            <button className="button-save" onClick={handleNewPlate}>
              Salvar alterações
            </button>
          {/* </div> */}
